...
For Each ws In Worksheets
    ...
    'Set the variables as the type they are for everything I will need
    ...
    TickerCount = 2
    'need to make sure my row starts at right place
    j = 2
        ...
        'Need to make sure it is looping all rows
            For i = 2 To LastrowA
                ...
                'Use formula to check if the Ticker sequence changed
                    ...
                    'Next for this row we need to calculate the yearly change which is the close value - the open value
                        ...
                        ' Now need to code for Percent Change in the next coloumn which is (close-open)/open and then formatted to be a percent
                        ...
                        'Calculate and insert the total stock volume values, making sure its only that specific ticker
